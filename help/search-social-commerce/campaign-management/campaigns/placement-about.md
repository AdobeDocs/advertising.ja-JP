...
[!UICONTROL Placements] > [!UICONTROL Placements] ビューにはプレースメントがすべて一覧表示され、[!UICONTROL Placements] > [!UICONTROL Negatives] ビューには広告が表示されないネガティブプレースメントがすべて一覧表示されます。

広告グループのプレースメントは、[!UICONTROL Placements] > [!UICONTROL Placements] ビューから作成できます。 任意の広告グループまたはキャンペーンに対して、[!UICONTROL Placements] > [!UICONTROL Negatives] ビューまたはキャンペーンと広告グループの設定から、否定的なキーワードを作成できます。  また、アクティブなプレースメントと一時停止したプレースメントのステータスを編集および変更したり、負のプレースメントを削除したりすることもできます。

>[!NOTE]
>
>[!DNL Google Ads]は、プレースメントの広告レベルのパフォーマンスデータを提供していません。
