...
**[!UICONTROL Images]:**&#x200B;広告用のJPEGまたはPNG画像は最大15枚です。 アスペクト比が1.91:1の画像を少なくとも1つ含めます。 [&#x200B; オーディエンスと画像](https://help.ads.microsoft.com/#apex/ads/en/56912/0)の許可された縦横比とディメンションを参照してください。
