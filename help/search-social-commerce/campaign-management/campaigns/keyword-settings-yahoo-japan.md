...
**[!UICONTROL Keywords]:** キーワード。 最大長は80文字で、キーワードの[[!DNL LY Ads] 一致タイプ構文](https://ads-help.yahoo-net.jp/s/article/H000044997)を含みます。
...
>* LY広告のキーワードと一致タイプは変更可能であるため、既存のキーワードを削除せずに編集できます。
