...
コールアウト拡張機能は、サイトが提供する製品、サービス、プロモーションなどの情報テキストで、テキスト広告とともに表示することができます。 広告ネットワークは、広告を含む2から4つのコールアウトを表示する場合があります。

アカウントレベルで、コールアウトが広告とともに表示される日付を含む、共有コールアウトテキストと設定を作成します。
...
Search, Social, &amp; Commerceは、広告拡張機能のクリック数と、その拡張機能が含まれている広告に関連付けられたキーワードへのコンバージョン数をマッピングします。 Search, Social, &amp; Commerceでは、拡張機能レベルでのコストやクリックデータは利用できません。

[!DNL Google Ads]では、「[!UICONTROL Campaigns]」タブ/「[!UICONTROL Ad Extensions]」タブにコストとクリックデータが表示されます。
