...
**[!UICONTROL Google Recommended Budget]:** （オプション。すべての必須設定を使用し、広告グループのみを含むキャンペーンに適用） **[!UICONTROL Show Recommendation]** をクリックして、[!DNL Google Ads] が推奨する予算を表示します。 複雑なキャンペーンの場合、レコメンデーションの生成には最大 40 秒かかる場合があります。
