...
新しい UI で広告ネットワークアカウントを管理する手順については、「[ （新しい UI） API 接続を使用した広告ネットワークアカウントの管理 ](/help/search-social-commerce/new-ui/set-up/accounts/api-accounts/api-account-manage.md)」を参照してください。
