...
*[!DNL Google Ads]、[!DNL LY Ads] （旧称[!DNL Yahoo! Japan Ads]）、[!DNL Microsoft Advertising] （旧称[!DNL Bing Ads]）、[!DNL Yahoo DSP] （旧称[!DNL Yahoo! Display Network]）、[!DNL Yandex]および既存の[!DNL Baidu] アカウント*

Search, Social, &amp; Commerceは、（*syncs*）をサポートされている広告ネットワークアカウントと同期させ、広告のパフォーマンスを追跡、レポート、視覚化できるようにします。 [!DNL Yahoo DSP]を除くすべてのアドネットワークでは、オプションでSearch、Social、およびCommerceでアカウントのキャンペーンを管理できます。 [!DNL Yahoo DSP]、キャンペーンは読み取り専用です。 すべての広告ネットワークに対して、ポートフォリオにキャンペーンを追加することで、最適化機能で管理対象アカウントのキャンペーンの入札額、キャンペーン予算、キャンペーン入札戦略ターゲットを最適化できます。
