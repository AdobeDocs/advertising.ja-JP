---
title: ラベル分類の作成
description: ラベル分類を作成してアカウントコンポーネントをグループ化する方法について説明します。
...
ラベル分類を作成したら、分類に特定のラベル値を作成し、バルクシート [を使用して](classification-values-assign-campaign-management.md) キャンペーン管理ビュー[または](classification-values-assign-bulksheets.md)からアカウントエンティティにラベル値を割り当てることができます。
