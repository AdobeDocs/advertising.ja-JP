...
[!UICONTROL Insights & Reports] > [!UICONTROL Recommendations & Publisher Insights]以内に、次の操作を実行できます。
...
* 影響を受けるエンティティ、レコメンデーションを適用した人物、タイムスタンプなど、アカウントに適用された各レコメンデーションのログを表示します。
