...
* すべての制約は、「[」と呼ばれる単一の](https://experienceleague.adobe.com/docs/advertising/search-social-commerce/campaign-management/label-classifications/classification-about.html) ラベル分類[!UICONTROL Constraints]のラベル値です。
