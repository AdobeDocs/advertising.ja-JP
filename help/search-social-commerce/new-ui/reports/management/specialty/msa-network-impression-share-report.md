...
このレポートは、指定された[!DNL Microsoft Advertising] アカウントの広告配信（検索またはオーディエンス）およびネットワーク （例：[!DNL Microsoft] サイトと選択トラフィックまたはオーディエンス）別のキャンペーンレベルのインプレッション共有指標と基本的なトラフィック指標（コスト、クリック、インプレッション）を示します。
