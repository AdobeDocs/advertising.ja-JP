...
description: スプレッドシート ファイルでシミュレーションをダウンロードする方法を説明します。
...
一度に複数のシミュレーション用のデータをZIP形式のファイルにダウンロードできます。 ファイルには、選択したシミュレーションごとに1つの[!DNL Microsoft Excel] ワークブック （XLSX ファイル）が含まれます。
