...
1. **[!UICONTROL Ad Details]**&#x200B;の手順で、[Baidu テキスト ad](ad-settings-baidu-text.md)、[Google Ads expanded dynamic search ad](ad-settings-google-dsa.md) （現在はGoogle Adsで「dynamic search ad」と呼ばれています）、[Google Ads responsive search ad](ad-settings-google-rsa.md)、[Microsoft Advertising expanded dynamic search ad](ad-settings-microsoft-dsa.md)、[Microsoft Advertising multimedia ad](ad-settings-microsoft-multimedia.md)、[Microsoft Advertising product ad](ad-settings-microsoft-product.md)、[Microsoft Advertising responsive （audience） ad](ad-settings-microsoft-responsive.md)、[Microsoft Advertising responsive search ad](ad-settings-microsoft-rsa.md)、または{dex}を編集しますテキスト広告[&#128279;](ad-settings-yandex-text.md)設定。
