...
## 新しい[!UICONTROL Ad Groups] ビューから選択した広告グループから制約を割り当て解除する
...
>* [&#x200B; （新しいUI） キーワードの制約の割り当てを管理](/help/search-social-commerce/new-ui/target/keywords/keyword-constraint-assignments-manage.md)
