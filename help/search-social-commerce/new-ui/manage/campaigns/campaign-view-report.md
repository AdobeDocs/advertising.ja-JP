...
# （新しいUI） [!UICONTROL Campaigns] ビューからのデータビューレポートの管理

<!-- Wording??????  Filtered data reports? -->

*Beta機能*

[!UICONTROL Campaigns] ビューで1つ以上のキャンペーンのデータ行を含むレポートを生成し、レポートをMicrosoft Excel ワークシート ファイル （XLXS形式）としてダウンロードできます。 レポートには、表示されているすべての列がビューに含まれます。
...
>[!MORELIKETHIS]
>
>* [について[!UICONTROL Campaigns view]](campaign-view-about.md)
