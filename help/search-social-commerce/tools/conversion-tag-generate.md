...
追跡する指標のセットごとに個別のコンバージョンタグを作成します。
...
Adobe Experience Platform（旧称Adobe Experience Platform Launch）のタグを使用して、検索、ソーシャル、Commerceのコンバージョントラッキングを設定できます。 タグは、Adobe Experience Cloudのお客様が、付属の付加価値機能として利用できます。
