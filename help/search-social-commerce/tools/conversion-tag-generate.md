...
追跡する指標のセットごとに個別のコンバージョンタグを作成します。 検索、ソーシャル、Commerceで、またはAdobe Advertising拡張機能を備えたAdobe Experience Platform（旧称：Adobe Experience Platform Launch）のタグを使用して、タグを生成できます。
...
## Adobe Experience Platform タグとAdobe Advertising拡張機能を使用して、コンバージョントラッキングタグを実装する
