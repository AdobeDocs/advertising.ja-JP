...
データソースを一時停止すると、データソースとの今後の同期が停止されます。 フィードが現在同期中の場合は、最初にプロセスが完了し、Adobe Advertisingのデータが最新の状態になります。
...
1. データテーブルの上にあるツールバーで、![一時停止](/help/search-social-commerce/assets/pause.png "一時停止")をクリックします。
