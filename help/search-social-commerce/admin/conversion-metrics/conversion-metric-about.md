...
広告主のデータにアクセスできる各ユーザーは、利用可能な指標のリストから、特定の指標を含めるか省略することで、管理表示とレポートに表示される指標をカスタマイズできます。 十分なアクセス権限を持つユーザーは、ポートフォリオまたはDSP パッケージレベルのカスタム目標に関連付けることで、特定の指標に対して最適化することもできます。
