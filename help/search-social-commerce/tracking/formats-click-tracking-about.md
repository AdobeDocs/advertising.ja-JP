...
* `<tracking ID>`は、アカウント内で一意のキーワード、広告、またはプレースメントを識別するシステム生成トラッキング ID文字列の変数です。 文字列は広告ネットワークによって異なります。
...
[[!DNL Baidu] 形式](formats-click-tracking-baidu.md)、[[!DNL Google Ads] 形式](formats-click-tracking-google.md)、[[!DNL Microsoft Advertising] 形式](formats-click-tracking-microsoft.md)、[[!DNL Naver] 形式](formats-click-tracking-naver.md)、[[!DNL Yahoo DSP] 形式](formats-click-tracking-yahoo-display-network.md)、[[!DNL Yahoo! Japan Ads] 形式](formats-click-tracking-yahoo-japan.md)および[[!DNL Yandex] 形式](formats-click-tracking-yandex.md)を示す個別のページを参照してください。
