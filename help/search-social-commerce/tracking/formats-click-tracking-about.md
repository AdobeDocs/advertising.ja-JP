...
* `<ad network ID>`は、指定された広告ネットワークの数値IDの変数です。*の* 3[!DNL Google Ads]、*の* 10[!DNL Microsoft Advertising]、*の* 45[!DNL Meta]、*のの* 86[!DNL Yahoo! Display Network]、*の* 87[!DNL Naver]、*の* 88[!DNL Baidu]、*90*、[!DNL Yandex] *の* 94[!DNL Yahoo! Japan Ads]、*の* 105[!DNL Yahoo Native]、*の* 106[!DNL Pinterest] （非推奨）。
...
>* [の [!DNL Google Ads]](formats-click-tracking-google.md) クリックトラッキング形式
>* [の [!DNL Microsoft Advertising]](formats-click-tracking-microsoft.md) クリックトラッキング形式
>* [&#x200B; スポンサー広告のクリックトラッキング形式（ [!DNL Naver]](formats-click-tracking-naver.md)）
>* [&#x200B; スポンサー広告のクリックトラッキング形式（ [!DNL Yahoo! Japan Ads]](formats-click-tracking-yahoo-japan.md)）
