...
1. （オプション） [!UICONTROL Report Settings] ウィンドウで、デフォルト [ レポート設定 ](forecast-accuracy-report.md) を変更します。
   ...
   1. （[!UICONTROL Forecast Accuracy Report] のみ。オプション） **[!UICONTROL Columns tab]** をクリックし、レポートのデフォルト列を変更します。

   1. （[!UICONTROL Forecast Accuracy Report] のみ。オプション）「**[!UICONTROL Advanced Filters]**」タブをクリックして、デフォルトの詳細オプションを変更します。
