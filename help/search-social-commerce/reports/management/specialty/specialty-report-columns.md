...
| [!UICONTROL All Conversions] | （[!UICONTROL Google AI Max Search Term Combination] および [!UICONTROL MSA Ad Extension] レポート）コンバージョンの合計数。 [!UICONTROL Google AI Max Search Term Combination Report] の場合、この値には、メインの「コンバージョン」列に含まれていないコンバージョンアクションが含まれます。 |
...
| [!UICONTROL All Conversions Value Per Cost] | （[!UICONTROL Google AI Max Search Term Combination Report]）すべてのコンバージョンの値を広告インタラクションの合計コスト （クリック数、ビデオビュー数など）で割った値。 |
...
| [!UICONTROL Average CPM] | 1,000 （マイル）インプレッションあたりの平均コスト。 |
...
| [!UICONTROL Conversions] | （[!UICONTROL Google AI Max Search Term Combination]、[!UICONTROL Google Asset Group Performance] および [!UICONTROL MSA Ad Extension] レポート）指定した期間のコンバージョンの合計。 [!UICONTROL MSA Ad Extension] レポートの場合、これは販売またはその他の成功指標に至ったクリック数です。 [!UICONTROL Google AI Max Search Term Combination] レポートの場合、これは [ コンバージョンに含める ] が有効になっているコンバージョン アクションからのコンバージョンの合計数です |
...
| [!UICONTROL Conversions Value] | （[!UICONTROL Google AI Max Search Term Combination Report]） [ コンバージョンに含める ] が有効になっているコンバージョン アクションのすべてのコンバージョンの値。 |
| [!UICONTROL Conversions Value Per Cost] | （[!UICONTROL Google AI Max Search Term Combination Report]）すべてのコンバージョンの値を広告インタラクションの合計コスト （クリック数、ビデオビュー数など）で割った値。 「コンバージョンに含める」が有効になっているコンバージョンアクションからのコンバージョンのみが含まれます。 |
...
| [!UICONTROL Cost Per All Conversions] | （[!UICONTROL Google AI Max Search Term Combination Report]）広告インタラクションのコストを、すべてのコンバージョンで除算した値。 |
| [!UICONTROL Cost Per Assist] | （[!UICONTROL MSA Ad Extension] レポート）アシストあたりの合計コスト。 |
| [!UICONTROL Cost Per Conversion] | （[!UICONTROL Google AI Max Search Term Combination Report] および [!UICONTROL MSA Ad Extension] レポート））広告インタラクションのコストをコンバージョンで割った値です。 Google広告の場合、「コンバージョンに含める」が有効になっているコンバージョンアクションからのコンバージョンのみが含まれます。 |
...
| [!UICONTROL Cross Device Conversions] | （[!UICONTROL Google AI Max Search Term Combination Report]）ユーザーがあるデバイスで広告をクリックしてから、別のデバイスまたはブラウザーで変換した場合に発生するコンバージョン。 クロスデバイス変換は、すべてのコンバージョンに含まれます。 |
...
| [!UICONTROL Headline 1] | （[!UICONTROL Google AI Max Search Term Combination Report]）広告の最初のヘッドライン。 |
| [!UICONTROL Headline 2] | （[!UICONTROL Google AI Max Search Term Combination Report]）広告の 2 番目のヘッドライン。 |
...
| [!UICONTROL Search Term] | （[!UICONTROL AdWords Search Query Report]、[!UICONTROL Bing Ads Search Query Report] および [!UICONTROL Google AI Max Search Term Combination Report]）クリックが発生したユーザー検索語。 |
...
| [!UICONTROL Value Per All Conversions] | [!UICONTROL Google AI Max Search Term Combination Report] 全換算額を全換算数で除した額 |
| [!UICONTROL Value Per Conversion] | [!UICONTROL Google AI Max Search Term Combination Report] 転換価額を転換数で除した額 「コンバージョンに含める」が有効になっているコンバージョンアクションからのコンバージョンのみが含まれます。 |
