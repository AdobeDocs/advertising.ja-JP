---
title: 特殊レポートの生成
description: 専門性に関するレポートを生成する方法をご確認ください。
...
1. （[!UICONTROL AdWords Conversion Report]と[!UICONTROL AdWords Shopping Performance Report]のみ。オプション）レポートの最初の50行をプレビューするには、**[!UICONTROL Preview]**&#x200B;をクリックします。 完了したら、**[!UICONTROL Back]**&#x200B;をクリックしてレポート設定ページに戻ります。
