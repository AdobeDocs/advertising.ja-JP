...
スプレッドシート フィードに使用するレポートテンプレート、[!DNL Microsoft Excel] テンプレートおよびその他のパラメーターを変更できます。
...
1. スプレッドシートのフィード設定を変更します。
   ...
   * （オプション）フィードの[!UICONTROL Update Status]が&#x200B;*[!UICONTROL Finished]*&#x200B;になったら、フィードの横にある&#x200B;**[!UICONTROL XLSX]**&#x200B;をクリックし、ブラウザーの通常の手順に従ってファイルを開くか保存します。
