...
user-guide-description: 広告検索、ソーシャル、コマースの最新の更新および新機能について説明します。
...
+ はじめに {#intro}
   + [Adobe広告検索、ソーシャル、コマースについて](/help/search-social-commerce/introduction/about.md)
...
+ 一般的なタスク {#common-tasks}
   ...
   + データビューのカスタマイズ {#data-views}
      ...
      + アドホック表示設定 {#ad-hoc-settings}
         + [列見出しメニューから列セットを編集](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-column-heading.md)
         + [列セットを編集し、 [!UICONTROL Custom Columns] アイコン](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
         + [キャンペーン表示での列設定のロックとロック解除](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-lock-unlock.md)
         + [列の並べ替えを変更](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-sort.md)
         + [日付範囲でのデータのフィルタリング](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/date-filter.md)
         ...
         + 列の値でデータをフィルター {#filter-column-values}
   ...
   + 一般的なナビゲーション、編集、選択タスク {#navigation-editing-selection}
      + [複数行を選択](/help/search-social-commerce/common-tasks/navigation-editing-selection/multiple-rows-select.md)
      + [カレンダーを使用して日付を指定](/help/search-social-commerce/common-tasks/navigation-editing-selection/calendar.md)
      + [トレンドグラフの表示/非表示を切り替える](/help/search-social-commerce/common-tasks/navigation-editing-selection/trend-chard-show-hide.md)
      + [管理ビューのデータを更新](/help/search-social-commerce/common-tasks/navigation-editing-selection/refresh.md)
      + 管理ビューのデータのダウンロード {#download-data-views}
...
+ トラッキング {#tracking}
   ...
   + クリックの追跡 {#click-tracking}
      ...
      + クリック追跡 URL のコンポーネント {#click-tracking-components}
         + クリック追跡 URL の標準形式 {#click-tracking-formats}
            + [クリック追跡 URL の形式について](/help/search-social-commerce/tracking/formats-click-tracking-about.md)
            + [のクリック追跡形式 [!DNL Baidu]](/help/search-social-commerce/tracking/formats-click-tracking-baidu.md)
            + [のクリック追跡形式 [!DNL Google Ads]](/help/search-social-commerce/tracking/formats-click-tracking-google.md)
            + [のクリック追跡形式 [!DNL Microsoft Advertising]](/help/search-social-commerce/tracking/formats-click-tracking-microsoft.md)
            + [のクリック追跡形式 [!DNL Naver]](/help/search-social-commerce/tracking/formats-click-tracking-naver.md)
            + [のクリック追跡形式 [!DNL Yahoo! Display Network]](/help/search-social-commerce/tracking/formats-click-tracking-yahoo-display-network.md)
   ...
   + コンバージョントラッキング {#conversion-tracking}
      ...
      + Adobe広告コンバージョントラッキング {#advertising-conversion-tracking}
      ...
      + フィードを使用した広告主がトラッキングしたコンバージョン{#conversion-feeds}
         + EF ID を使用するフィード {#ef-ids}
         ...
         + トランザクション ID を使用するフィード {#transaction-ids}
         ...
         + [コンバージョンフィードファイルのファイル要件](/help/search-social-commerce/tracking/feed-file-requirements.md)
   + [トラッキングに関する FAQ](/help/search-social-commerce/tracking/faqs-tracking.md)
+ キャンペーン管理 {#campaign-management}
   + はじめに {#campaign-management-intro}
   ...
   + アカウントの設定 {#campaign-management-accounts}
      + 広告ネットワークアカウント {#ad-network-accounts}
         ...
         + [の s\_kwcid トラッキングコードを更新します。 [!DNL Google Ads] アカウント](/help/search-social-commerce/campaign-management/accounts/update-skwcid-google.md)
   ...
   + キャンペーンの管理 {#management}
      + [広告ネットワークキャンペーン管理のオプション](/help/search-social-commerce/campaign-management/campaigns/campaign-management-options.md)
      + 内のデータの管理 [!UICONTROL Campaigns] > [!UICONTROL Campaigns] ビュー {#campaigns}
         ...
         + キーワード {#keywords}
            ...
            + [キーワードと除外キーワードのステータスの変更](/help/search-social-commerce/campaign-management/campaigns/keyword-status-edit.md)
         ...
         + 広告 {#ads}
            ...
            + 広告ネットワーク別の広告設定 {#ad-settings-by-network}
               + [[!DNL Baidu] テキスト広告設定](/help/search-social-commerce/campaign-management/campaigns/ad-settings-baidu-text.md)
               + [[!DNL Google Ads] 呼び出しのみの広告設定](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-call.md)
               ...
               + [[!DNL Microsoft Advertising] レスポンシブ（オーディエンス）広告設定](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-responsive.md)
               ...
               + [[!DNL Yandex] テキスト広告設定](/help/search-social-commerce/campaign-management/campaigns/ad-settings-yandex-text.md)
         ...
         + 配置 {#placements}
            ...
            + [入札可能な配置の管理](/help/search-social-commerce/campaign-management/campaigns/placement-manage.md)
            + [ネガティブな配置の作成](/help/search-social-commerce/campaign-management/campaigns/placement-negative-create.md)
            + [配置と負の配置のステータスの変更](/help/search-social-commerce/campaign-management/campaigns/placement-status-edit.md)
         ...
         + オーディエンスとオーディエンスのターゲット {#audiences-and-targets}
            + Audiences {#audiences}
               ...
               + オーディエンスのターゲットと除外 {#audience-targets}
         ...
         + 広告の拡張 {#ad-extensions}
            + [!DNL Google Ads] 引き出し線拡張 {#callouts}
               + [について [!DNL Google Ads] 引き出し線拡張](/help/search-social-commerce/campaign-management/campaigns/callout-extension-about.md)
            ...
            + Sitelink の拡張 {#sitelinks}
               ...
               + [共有サイトリンクをアカウント、キャンペーンおよび広告グループに関連付ける](/help/search-social-commerce/campaign-management/campaigns/sitelink-extension-associate.md)
      ...
      + 一括シートを使用した一括データの管理 {#bulksheets}
         ...
         + [バルクシートファイルまたは修正済みエラーファイルのアップロード](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-upload.md)
         + [バルクシートの投稿または修正されたエラーファイル](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-post.md)
         + [バルクシートエラー](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-errors.md)
         + [アップロードしたバルクシートとエラーファイルを削除](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-delete.md)
         + [進行中のバルクシートジョブを停止します](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-stop-job.md)
         + バルクシートに必須/含まれるデータ{#bulksheet-data-formats}
            ...
            + [次に必要なバルクシートデータ： [!DNL Baidu] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-baidu.md)
            + [次に必要なバルクシートデータ： [!DNL Google Ads] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-google.md)
            + [次に必要なバルクシートデータ： [!DNL Microsoft Advertising] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-microsoft.md)
            + [次に必要なバルクシートデータ： [!DNL Naver] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-naver.md)
            + [のバルクシートデータ [!DNL Yahoo! Display Network] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-display-network.md)
            + [のバルクシートデータ [!DNL Yahoo! Japan] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yahoo-japan.md)
      ...
      + 在庫フィードを使用したキャンペーンデータの自動化 {#inventory-feeds}
         ...
         + テンプレート {#feed-templates}
            ...
            + [[!DNL Google Ads] 買い物広告テンプレート設定](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
            + [[!DNL Microsoft Advertising] 買い物広告テンプレート設定](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
         ...
         + フィードから作成されたキャンペーンデータの使用 {#propagated-data}
            ...
            + [フィードから広告ネットワークに生成されたキャンペーンデータを投稿](/help/search-social-commerce/campaign-management/inventory-feeds/propagated-data-post.md)
            + [在庫フィードデータの転記ジョブを停止します](/help/search-social-commerce/campaign-management/inventory-feeds/stop-job.md)
      ...
      + 一意のワークフローを使用したキャンペーンと広告の実装{#special-campaign-types}
         + [実装方法 [!DNL Google Ads] 動的検索広告](/help/search-social-commerce/campaign-management/special-campaign-types/google-dynamic-search-ads.md)
         + [実装方法 [!DNL Google Ads] 最大パフォーマンスキャンペーン](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
      ...
      + [広告ネットワークデータを手動で同期](/help/search-social-commerce/campaign-management/campaigns/sync-network.md)
   ...
   + ラベル分類の管理 {#label-classifications}
      ...
      + [ラベルの分類の作成](/help/search-social-commerce/campaign-management/label-classifications/classification-create.md)
      + [分類値をキャンペーン管理ビューからアカウントコンポーネントに割り当てる](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-campaign-management.md)
      + [一括送信シートを使用して、勘定科目コンポーネントに分類値を割り当てます。](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
...
+ インサイトとレポート {#insights-reports}
   + 広告インサイト {#insights}
      + [について [!UICONTROL Advertising Insights]](/help/search-social-commerce/advertising-insights/insight-about.md)
      + [を生成 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-generate.md)
      + [表示または保存 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [の削除 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + レポート {#reports}
      ...
      + レポートの管理 {#report-management}
         ...
         + アシストレポート {#assist-reports}
            ...
            + アシストレポート形式 {#assist-report-formats}
         ...
         + 特殊レポート {#specialty-reports}
            ...
            + 特殊なレポート形式 {#specialty-report-formats}
         ...
         + モデル精度レポート {#model-accuracy-reports}
            ...
            + モデルの精度レポートの形式 {#assist-report-formats}
               + [この [!UICONTROL Forecast Accuracy Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-report.md)
               + [この [!UICONTROL Forecast Accuracy (Actuals) Report]](/help/search-social-commerce/reports/management/model-accuracy/forecast-accuracy-actuals-report.md)
      ...
      + レポートの自動化 {#report-automation}
         ...
         + スプレッドシートフィード {#spreadsheet-feeds}
            ...
            + [の作成 [!DNL Excel] スプレッドシートレポートフィードのテンプレート](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
            ...
            + [スプレッドシートレポートフィードファイルの表示または保存](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-view-or-save.md)
   ...
   + 通知 {#notifications}
      ...
      + [次のプッシュ通知を有効/無効にする： [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
      + [をインストールしてアンインストールします。 [!UICONTROL Notification Center] web アプリケーション](/help/search-social-commerce/notifications/notification-app-install-uninstall.md)
   + Custom Alerts {#alerts}
      + [Custom Alerts について](/help/search-social-commerce/alerts/alert-about.md)
...
+ ツール {#tools}
   ...
   + 用の指標のアップロード [!DNL Naver] トラッキング専用アカウント {#generic-tracking}
   ...
   + [複製 [!DNL Google Ads] キャンペーン [!DNL Microsoft Advertising]](/help/search-social-commerce/tools/google-campaign-replication-in-microsoft.md)
+ 管理 {#admin}
   + [ロールについて](/help/search-social-commerce/admin/role-about.md)
   + [Ad Network Manager アカウントの資格情報の管理](/help/search-social-commerce/admin/manager-accounts.md)
   + [同期 [!DNL Adobe] audiences](/help/search-social-commerce/admin/sync-adobe-audiences.md)
   + データソースの設定 {#data-sources}
      + [同期について [!DNL Google Analytics] コンバージョン指標](/help/search-social-commerce/admin/data-sources/data-source-about.md)
      + [の設定の前提条件 [!DNL Google Analytics] データソース](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [の設定 [!DNL Google Analytics] データソースとして表示](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [の編集 [!DNL Google Analytics] データソース](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
      + [データソースの同期を一時停止する](/help/search-social-commerce/admin/data-sources/data-source-pause.md)
