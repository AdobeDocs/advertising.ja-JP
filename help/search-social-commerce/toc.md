...
+ 共通タスク {#common-tasks}
   ...
   + データビューのカスタマイズ {#data-views}
      ...
      + アドホックビュー設定 {#ad-hoc-settings}
         ...
         + [から列セットを編集して並べ替える [!UICONTROL Custom Columns] アイコン](/help/search-social-commerce/common-tasks/data-views/ad-hoc-settings/column-set-edit-sort-icon.md)
...
+ トラッキング {#tracking}
   ...
   + コンバージョントラッキング {#conversion-tracking}
      ...
      + Adobe Advertisingコンバージョントラッキング {#advertising-conversion-tracking}
...
+ キャンペーン管理 {#campaign-management}
   + はじめに {#campaign-management-intro}
      ...
      + [[!DNL Microsoft Advertising] 検索、ソーシャル、Commerceのコンバージョンデータ](/help/search-social-commerce/campaign-management/introduction/microsoft-conversion-data.md)
   + アカウントの設定 {#campaign-management-accounts}
      + 広告ネットワークアカウント {#ad-network-accounts}
         ...
         + [の AMO ID トラッキングコードの更新 [!DNL Google Ads] アカウント](/help/search-social-commerce/campaign-management/accounts/update-amo-id-google.md)
   ...
   + キャンペーンの管理 {#management}
      ...
      + 内でのデータの管理 [!UICONTROL Campaigns] > [!UICONTROL Campaigns] 表示 {#campaigns}
         ...
         + 広告 {#ads}
            ...
            + 広告ネットワークによる広告設定 {#ad-settings-by-network}
               ...
               + [[!DNL Google Ads] 動的検索広告設定を拡張しました](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-dsa.md)
               + [[!DNL Google Ads] レスポンシブ検索広告設定](/help/search-social-commerce/campaign-management/campaigns/ad-settings-google-rsa.md)
               + [[!DNL Microsoft Advertising] 動的検索広告設定を拡張しました](/help/search-social-commerce/campaign-management/campaigns/ad-settings-microsoft-dsa.md)
         ...
         + オーディエンスとオーディエンスターゲット {#audiences-and-targets}
            + オーディエンス {#audiences}
               ...
               + [作成 [!DNL Google Ads] のカスタマーマッチオーディエンス [!DNL Adobe] オーディエンス](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-adobe-audience.md)
               + [を作成 [!DNL Google Ads] Adobe Campaign メールリストからのカスタマーマッチオーディエンス](/help/search-social-commerce/campaign-management/campaigns/google-audience-from-campaign-email-list.md)
         ...
         + 広告拡張機能 {#ad-extensions}
            + [!DNL Google Ads] コールアウト拡張機能 {#callouts}
               + [について [!DNL Google Ads] コールアウト拡張機能](/help/search-social-commerce/campaign-management/campaigns/callout-extension-about.md)
               + [管理 [!DNL Google Ads] コールアウト拡張機能](/help/search-social-commerce/campaign-management/campaigns/callout-extension-manage.md)
               + [関連付け [!DNL Google Ads] キャンペーンまたは広告グループと共有されたコールアウト拡張機能](/help/search-social-commerce/campaign-management/campaigns/callout-extension-associate.md)
      ...
      + バルクシートを使用したバルクデータの管理 {#bulksheets}
         ...
         + バルクシートへの必須/含まれるデータ{#bulksheet-data-formats}
            ...
            + [に必要なバルクシート データ [!DNL Baidu] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-baidu.md)
            + [に必要なバルクシート データ [!DNL Google Ads] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-google.md)
            + [に必要なバルクシート データ [!DNL Microsoft Advertising] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-microsoft.md)
            + [に必要なバルクシート データ [!DNL Naver] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-naver.md)
            ...
            + [に必要なバルクシート データ [!DNL Yandex] アカウント](/help/search-social-commerce/campaign-management/bulksheets/bulksheet-data-formats/bulksheet-data-yandex.md)
      + 在庫フィードを使用したキャンペーンデータの自動化 {#inventory-feeds}
         ...
         + テンプレート {#feed-templates}
            ...
            + [[!DNL Google Ads] 買い物とテンプレートの設定](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-google-shopping.md)
            + [[!DNL Microsoft Advertising] 買い物とテンプレートの設定](/help/search-social-commerce/campaign-management/inventory-feeds/ad-templates/template-microsoft-shopping.md)
      ...
      + 一意のワークフローを使用したキャンペーンと広告の実装{#special-campaign-types}
         ...
         + [実装方法 [!DNL Google Ads] パフォーマンス最大キャンペーン数](/help/search-social-commerce/campaign-management/special-campaign-types/google-performance-max-campaigns.md)
   ...
   + ラベル分類の管理 {#label-classifications}
      ...
      + [バルクシートを使用したアカウントコンポーネントへの分類値の割り当て](/help/search-social-commerce/campaign-management/label-classifications/classification-values-assign-bulksheets.md)
...
+ インサイトとレポート {#insights-reports}
   + 広告インサイト {#insights}
      ...
      + [を表示または保存します [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-view-save.md)
      + [を削除 [!DNL Advertising Insight]](/help/search-social-commerce/advertising-insights/insight-delete.md)
   + レポート {#reports}
      ...
      + レポートの管理 {#report-management}
         ...
         + 専門レポート {#specialty-reports}
            ...
            + 専門レポートのフォーマット {#specialty-report-formats}
               ...
               + [この [!UICONTROL MSA Network Impression Share Report]](/help/search-social-commerce/reports/management/specialty/msa-network-impression-share-report.md)
               + [この [!UICONTROL MSA Network Performance Report]](/help/search-social-commerce/reports/management/specialty/msa-network-performance-report.md)
      ...
      + レポートの自動化 {#report-automation}
         ...
         + スプレッドシートフィード {#spreadsheet-feeds}
            ...
            + [を作成 [!DNL Excel] スプレッドシートレポートフィードのテンプレート](/help/search-social-commerce/reports/automation/spreadsheet-feeds/spreadsheet-feed-create-excel-template.md)
   ...
   + 通知 {#notifications}
      ...
      + [からのプッシュ通知の有効化と無効化 [!UICONTROL Notification Center]](/help/search-social-commerce/notifications/notifications-push-enable-disable.md)
...
+ ツール {#tools}
   ...
   + の指標のアップロード [!DNL Naver] トラッキング専用アカウント {#generic-tracking}
      + [のトラフィックおよびコンバージョン指標のアップロード [!DNL Naver] トラッキング専用アカウント](/help/search-social-commerce/tools/metrics-upload-tracking-campaigns/naver-tracking-campaigns-upload-metrics.md)
      + [の指標データの要件 [!DNL Naver] トラッキング専用アカウント](/help/search-social-commerce/tools/metrics-upload-tracking-campaigns/naver-tracking-campaigns-data-requirements.md)
   + [追加の在庫同期を有効にする](/help/search-social-commerce/tools/sync-inventory.md)
   + [Replicate [!DNL Google Ads] のキャンペーン [!DNL Microsoft Advertising]](/help/search-social-commerce/tools/google-campaign-replication-in-microsoft.md)
+ 管理 {#admin}
   ...
   + [同期 [!DNL Adobe] オーディエンス](/help/search-social-commerce/admin/sync-adobe-audiences.md)
   + データソースの設定 {#data-sources}
      ...
      + [を設定するための前提条件 [!DNL Google Analytics] データソース](/help/search-social-commerce/admin/data-sources/data-source-prerequisites.md)
      + [の設定 [!DNL Google Analytics] をデータソースとして表示](/help/search-social-commerce/admin/data-sources/data-source-configure.md)
      + [を編集 [!DNL Google Analytics] データソース](/help/search-social-commerce/admin/data-sources/data-source-edit.md)
   ...
   + 広告主のコンバージョン指標の管理{#conversion-metrics}
      ...
      + コンバージョンタグの管理 {#conversion-tags}
         + [のコンバージョンタグを作成 [!DNL Google Ads]](/help/search-social-commerce/admin/conversion-metrics/conversion-tag-google.md)
+ [ヘルプを表示](get-help.md)
+ [用語集](glossary.md)
