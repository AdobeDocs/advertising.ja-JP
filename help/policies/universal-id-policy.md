...
サービスを通じてUID2 ユニバーサル ID の使用を選択すると、UID2 ユニバーサル ID に関連してオンデマンドサービスを通じて送信、保存、表示、配布、またはその他の方法で利用できるすべてのクライアントデータが、本契約書で示す [UID2 禁止国のいずれかに居住する個人に関係しないことを確認することに同意することになり ](#prohibited-countries-uid2) す。
