...
Audience Managerで、DSP インプレッション用の[&#x200B; データソース &#x200B;](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/data-sources/datasources-list-and-settings.html)を作成し、「データ」をクリックします。 追跡されたすべてのイベントがデータソースに関連付けられるように、各イベントタグ [にデータソース ID &#x200B;](#implement-dsp-pixels)を含めます。
