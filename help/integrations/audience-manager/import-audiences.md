...
* 組織は、[Experience Cloudサービスを有効にする ](https://experienceleague.adobe.com/en/docs/core-services/interface/services/overview)Experience Cloud[!DNL Organization ID] （以前の [!DNL IMS org ID]）が必要です。
