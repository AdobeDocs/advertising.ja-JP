...
* （[!DNL Analytics] を使用する広告主）広告主は、バージョン 1.6.4 以降 [&#x200B; [!DNL Analytics]  使用して `appMeasurement.js` 実装 &#x200B;](https://experienceleague.adobe.com/ja/docs/analytics/implementation/js/overview) する必要があります。
