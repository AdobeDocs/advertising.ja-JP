...
You can find both of these IDs on the [Summary tab of the Adobe Experience Platform Debugger](https://experienceleague.adobe.com/docs/debugger/using-v2/summary.html?lang=ja).
