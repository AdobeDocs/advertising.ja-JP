---
title: タグに  [!DNL Analytics for Advertising]  マクロを追加  [!DNL Google Campaign Manager 360]  追加
...
# 広告タグ [!DNL Analytics for Advertising] マクロ [!DNL Google Campaign Manager 360] 追加
...
## DSP[!DNL Analytics for Advertising] マクロを拡張する方法
