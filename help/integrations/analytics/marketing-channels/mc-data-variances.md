---
title: チャネルデータがAdobe Advertisingとで異なる可能性がある理由  [!DNL Marketing Channels]
...
Adobe Advertisingで追跡されたデータと [!DNL Analytics] で追跡されたデータの間で発生する可能性のあるデータの相違について詳しくは、「[ とAdobe Advertisingの間で予想されるデータの相違  [!DNL Analytics]  を参照してください ](../data-variances.md)。
