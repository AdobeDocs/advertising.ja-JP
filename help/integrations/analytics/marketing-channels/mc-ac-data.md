...
次の図に、1 人の訪問者のジャーニーを構成する個々の訪問をAdobe Advertisingと [!DNL Marketing Channels] でトラッキングする方法を示します。 [!DNL Analytics] のAdobe Advertising レポートは、AMO ID を使用して、Adobe Advertisingを通じてトラフィックに送信される、有料ディスプレイ、検索、ソーシャルおよびコマースチャネル広告のみに制限されます。 ただし、[!DNL Marketing Channels] では、[!DNL Marketing Channels] 処理ルールで設定されたすべてのチャネルが追跡されます。
