...
Adobe Advertising ID （[AMO ID および EF ID](../ids.md)）を使用して、Adobe Analyticsで [!DNL Marketing Channels] 処理ルールを設定できます。 Adobe Advertising キャンペーンに固有のルールには、Adobe Advertising ID を使用します。
...
[!DNL Marketing Channels] チャネルの [!UICONTROL Paid Search] の処理ルールは、次のようになります。

![[!UICONTROL Paid Search] ルールの例 ](/help/integrations/assets/a4adc-mc-rule-paidsearch.png)

[!DNL Marketing Channels] チャネルの [!UICONTROL YouTube Video Ads] の処理ルールは、次のようになります。
