---
title: タグに  [!DNL Analytics for Advertising]  マクロを追加  [!DNL Flashtalking]  追加
...
# 広告タグ [!DNL Analytics for Advertising] マクロ [!DNL Flashtalking] 追加
...
>[!NOTE]
>
>組織が [!DNL Flashtalking] と直接パートナーシップを結んでいる場合、この手順は必要ありません。 代わりに、[!DNL Flashtalking] アカウントにログインし、[!DNL Flashtalking]https://support.flashtalking.com/hc/en-us/articles/4409808166419-Accessing-Data-Pass-Macros[ にある ](https://support.flashtalking.com/hc/en-us/articles/4409808166419-Accessing-Data-Pass-Macros) サポートのドキュメントに従って、データパスマクロを使用して `s_kwcid` および `ef_id` トラッキングパラメーターを追跡します。

次のタイプの [!DNL Flashtalking] 実装 [!DNL Analytics for Advertising] ディスプレイ広告とビデオ広告にマクロを使用します。
