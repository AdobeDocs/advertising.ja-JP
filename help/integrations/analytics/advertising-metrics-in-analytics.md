...
description: Analysis WorkspaceでのAdobe Advertisingの指標と分類
...
AMO ID ディメンションの「[分類](https://experienceleague.adobe.com/ja/docs/analytics/components/dimensions/amo-id#classifications)」を参照してください。
<!--
