...
>[!TIP]
>
> [&#x200B; [!DNL Analytics for Advertising]に関する](https://experienceleague.adobe.com/docs/advertising-learn/tutorials/analytics/intro-a4adc.html?lang=ja#analytics) ビデオの概要をご覧ください。
