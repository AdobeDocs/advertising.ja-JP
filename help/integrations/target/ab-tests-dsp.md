...
1. DSP インプレッションデータからAudience Manager セグメントを設定します。
   ...
   1. Audience Managerで新しい特性の [ テストセグメントを設定 ](https://experienceleague.adobe.com/docs/audience-manager/user-guide/features/segments/segment-builder.html?lang=ja) し、**[!UICONTROL Data Source]** として `Ad Cloud` を選択します。
