...
アカウントにアップロードされた任意の柔軟なクリエイティブテンプレートを使用して、事前定義済みのサイズの広告を作成できます。 使用するテンプレートを選択したら、クリックのタグと属性を編集します。
...
1. クリエイティブを指定します。
   ...
   * GenStudio エクスペリエンスの場合、次の操作を行います。
     ...
     選択したエクスペリエンスの各クリエイティブバリアントが、個別のHTML5 クリエイティブとして読み込まれます。
...
1. [HTML5 クリエイティブ設定 &#x200B;](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-html5) または [&#x200B; 画像クリエイティブ設定 &#x200B;](/help/creative/creative-libraries/creative-settings-standard.md#creative-settings-image) を指定します。
   ...
   デフォルトでは、アップロードしたクリエイティブまたはGenStudio エクスペリエンスがすべて選択され、指定した設定は選択したすべての項目に適用されます。 値が 1 つだけの設定は、選択したすべての項目に適用されます。 特定のクリエイティブまたはGenStudio エクスペリエンスの設定を入力するには、適用されない各クリエイティブまたはエクスペリエンスの選択を解除します。
