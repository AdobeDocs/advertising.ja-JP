...
1. 広告要素を設定します。
   ...
   * （動的なHTML5 およびビデオ広告の場合）広告要素のカタログを作成します。
      ...
      1. [&#x200B; フィードテンプレートを作成 &#x200B;](/help/creative/feeds/feed-template-manage.md) して、フィードファイル（スプレッドシート）のフィールドをAdvertising Creative バックエンドのフィールドにマッピングします。 オプションで、ユニバーサルフィードテンプレートをダウンロードして、任意のキャンペーンタイプに関連するフィールドに入力することもできます。
