---
title: 決定木のターゲティングなしでエクスペリエンスを作成
description: ターゲティングを使用せずに広告体験を構築する方法をご紹介します。
...
# 決定木のターゲティングなしでエクスペリエンスを作成

ターゲティングなしで広告体験を構築。 各エクスペリエンスでは、単一のクリエイティブライブラリから広告を利用できます。

>[!NOTE]
>
> ターゲティングされていないエクスペリエンスを作成した後で、別のワークフローを使用するターゲットエクスペリエンスに変更することはできません。
