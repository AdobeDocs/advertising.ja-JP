---
title: クリエイティブを広告タグに割り当てて、ターゲティングすることなくエクスペリエンスを獲得
...
>[!NOTE]
>
>決定ツリーのターゲティングを使用するエクスペリエンスの場合、決定ツリー[!DNL Creative]内からクリエイティブをエクスペリエンスに割り当てると、適用できるクリエイティブサイズごとに1つのタグが自動的に作成されます。
...
1. 追加する各クリエイティブの横にあるチェックボックスをオンにします。
   ...
   エクスペリエンスに関連するクリエイティブタイプ（標準または動的）のクリエイターのみが一覧表示されます。
