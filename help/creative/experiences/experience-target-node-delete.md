---
title: エクスペリエンス内のターゲットノードまたはクリエイティブリーフノードの削除
...
# エクスペリエンス内のターゲットノードまたはクリエイティブリーフノードの削除

*デシジョンツリーのターゲティングのみ*&#x200B;のエクスペリエンス

すべての子ターゲットとそれらに割り当てられたクリエイティブバンドルを含むターゲットノードを削除できます。 クリエイティブなリーフ ノードを削除することもできます。
