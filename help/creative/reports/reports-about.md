...
* **[!UICONTROL All-in Cost]**: （Advertising CreativeDSPと広告主の両方を使用している広告主のみ。ベータ版機能）このレポートを使用して、Adobe Creativeの広告サービスに対するAdvertising DSPの支出の割合を確認します。 クリエイティブ、属性、ターゲットなどのデータは、キャンペーン、パッケージ、プレースメント、広告の各レベルで表示できます。
