---
title: バルクシートを使用した広告の詳細の確認と編集
description: スプレッドシートを使用して広告設定を一括で確認する方法について説明します。
feature: DSP Ads
...
>* 複数の広告のサードパーティのトラッキングピクセルを一度に変更したり、広告をプレースメントに添付したりするには、「[広告をプレースメントに添付](/help/dsp/campaign-management/ads/ad-attach-to-placement.md)」も参照してください。
