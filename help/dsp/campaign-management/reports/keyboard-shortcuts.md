...
| 適用可能なページ | ショートカット | 説明 |
| ---------------| ----------- | ---------------------- |
| 配置の設定 | o | [!UICONTROL Goals]設定に移動します |
| 配置の設定 | g | [!UICONTROL Geos]設定に移動します |
| 配置の設定 | i | [!UICONTROL Inventory]設定に移動します |
| 配置の設定 | s | [!UICONTROL Sites]設定に移動します |
| 配置の設定 | a | [!UICONTROL Audience]設定に移動します |
| 配置の設定 | b | [!UICONTROL Brand Safety]設定に移動します |
| 配置の設定 | t | [!UICONTROL Tracking]設定に移動します |
| 配置の設定 | l | [!UICONTROL Adobe Labs]設定に移動します |
