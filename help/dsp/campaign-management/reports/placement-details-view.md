...
## プレースメント [!UICONTROL Inspector] ージの情報 {#placement-inspector}
...
## プレースメント [!UICONTROL Inspector] を開く {#inspector-open}
...
## [!UICONTROL Inspector] ージからプレースメントから広告を削除 {#remove-ads-placement-inspector}

1. [ プレースメント [!UICONTROL Inspector]](#inspector-open) ージを開きます。
