...
| [!UICONTROL Dimension] | [!UICONTROL Device] | [!UICONTROL Device Environment] | プレースメントのターゲットとなるデバイス環境：（*[!UICONTROL Desktop]*、*[!UICONTROL Mobile]*、*[!UICONTROL Connected TV]）*。 |
...
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Clicks] | クリック総数。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL CTR] | クリックの割合をインプレッション数で割った値。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Engagements] | 提供された広告でのインタラクションの数。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Engagement Rate] | 提供された広告でのインタラクションの割合（インプレッション数で割る）。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Impressions] | 合計インプレッション数。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Media Match Rate] | クリエイティブが目的のメディア/在庫またはオーディエンスと正常に一致したインプレッション数（またはイベント）の割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product Clicks] | 特定の製品に起因するクリック総数。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product Conversions] | 特定の製品に起因するコンバージョンの合計。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product Conversion Rate] | 特定の製品に起因する [!UICONTROL Product Conversions] で [!UICONTROL Product Impressions] 割されます。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product CTR] | 特定の製品に起因する [!UICONTROL Product Clicks] で [!UICONTROL Product Impressions] 割されます。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product Impressions] | 特定の製品に起因する合計インプレッション数。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Product Revenue] | 特定の製品に起因する合計売上高。 クリエイティブで複数の製品（カルーセル広告など）を表示し、製品別にレポートする場合に使用します。 |
| [!UICONTROL Metrics] | [!UICONTROL Standard] | [!UICONTROL Revenue] | 合計売上高。 |
...
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 100% Completion Rate] | （カスタムCreativeレポート）広告全体を視聴したビューの割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 100% Completions] | （カスタムCreativeレポート）広告全体を視聴したビューの数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 25% Completion Rate] | （カスタムCreativeレポート）広告の 4 分の 1 以上を視聴したビューの割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 25% Completions] | （カスタム Creative レポート）広告の少なくとも 1 四分の一を視聴したビューの数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 50% Completion Rate] | （カスタムCreativeレポート）広告の 4 分の 2 以上を視聴したビューの割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 50% Completions] | （カスタムCreativeレポート）広告の 4 分の 2 以上を視聴したビューの数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 75% Completion Rate] | （カスタムCreativeレポート）広告が 3 四分の 1 以上視聴されたビューの割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL 75% Completions] | （カスタムCreativeレポート）広告が 3 四分の 1 以上視聴されたビューの数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Avg Percent Viewed] | （カスタムCreativeレポート）すべてのビューを対象とした、広告の最後まで視聴された平均の割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Play Rate] | （カスタム Creative レポート）ビデオビューにつながったインプレッション数の割合。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Playtime per View] | （カスタム Creative レポート）ビデオビューの平均時間（秒単位）。 |
...
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Video Resume] | （カスタム Creative レポート）ビデオが一時停止の後に再開された合計回数。 |
...
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Video Unmute] | （カスタム Creative レポート）ビデオがミュート解除された合計回数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Viewed Minutes] | （カスタム Creative レポート）ビデオ広告が表示された合計分数。 |
| [!UICONTROL Metrics] | [!UICONTROL Video] | [!UICONTROL Views] | （カスタム Creative レポート）ビデオ広告ビューの合計数。 |
