...
+ キャンペーン管理 {#campaign-management}
   ...
   + 広告 {#ads}
      ...
      + [ プレースメントからの広告の添付と削除 ](https://experienceleague.adobe.com/docs/advertising/dsp/campaign-management/placements/ad-attach-to-placement.html?lang=ja)<!-- Dupe link to this file (in Placements chapter), so need to use an absolute link in one of the listings -->
