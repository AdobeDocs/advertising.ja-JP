---
title: 認証済みセグメントの手動インポート元  [!DNL LiveRamp]
...
# 認証済みセグメントを [!DNL LiveRamp] から手動でインポート

*Beta機能*

[!DNL LiveRamp] [!DNL LiveRamp] ダッシュボードを使用すると、認証済み [!DNL Connect] セグメントを手動でDSPに送信できます。 読み込んだセグメントをプレースメントのターゲティングに使用できます。 ファーストパーティセグメントの場合、料金は配信されたディスプレイ広告インプレッションあたり 0.15 ドル、ビデオ広告インプレッションあたり 0.25 ドルです。
