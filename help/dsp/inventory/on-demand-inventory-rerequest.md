...
# プレミアム在庫取引 [!DNL On Demand] 再リクエスト
...
1. インベントリを再要求します。
   ...
   1. （任意）必要に応じて、「[!UICONTROL Subscription]」および「[!UICONTROL Deal]」をクリックして、フィルターに基づくすべてのパブリッシャーのロゴを表示する **[!UICONTROL Subscription view]** ビューと、フィルターに基づいて各パブリッシャーのすべての取引を一覧表示する **[!UICONTROL Deal view]** ビューを切り替えます。
   ...
   * [!UICONTROL Subscription] ビューで、次の操作を行います。
      ...
      1. 該当する行の **[!UICONTROL Rerequest]** 列の「[!UICONTROL Action]」をクリックします。
