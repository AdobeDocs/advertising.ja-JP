...
>[!NOTE]
>
>SSP パートナーは変更される場合があります。 このリストは、現在のパートナーシップを反映しています。
...
| SSP | 会社 | シート ID | プログラムによるサポート | 地域 | サポートされている通貨 | サポートされているインベントリ |
| --- | --- | --- | --- | --- | --- | --- |
...
| [!DNL Magnite SpringServe (formerly Magnite Streaming)] | [!DNL Magnite] （以前の[!DNL Telaria]および[!DNL Tremor]） | [!DNL TubeMogul]またはAdobe Advertising | PG サポート | グローバル | AUD、USD | ビデオデスクトップ、モバイル、CTV |
| [!DNL Microsoft Monetize] | [!DNL Microsoft] （以前の[!DNL Xandr]、[!DNL AppNexus]） | ビデオシート ID: 9094<br> ディスプレイシート ID: 3939 | — | グローバル | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL Nexxen] | [!DNL Nexxen] （以前の[!DNL Unruly]） | Adobe Advertising | — | 米国+ EMEA | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL OpenX] | [!DNL OpenX] | [!DNL TubeMogul]またはAdobe Advertising | PG サポート | グローバル | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL PubMatic] | [!DNL Pubmatic] | [!DNL TubeMogul]またはAdobe Advertising | — | グローバル | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL ShareThrough] |  | [!DNL TubeMogul]またはAdobe Advertising | — | グローバル | USD | ディスプレイ デスクトップとモバイル <br><br> ネイティブ ディスプレイ <br><br> ビデオ デスクトップ、モバイル、およびCTV |
| [!DNL SmartClip] |  | Adobe Advertising | — | EMEA | すべての通貨 | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL Taboola] |  | Adobe Advertising | — | US/CA | USD | ビデオデスクトップとモバイル |
| [!DNL Teads] |  | [!DNL TubeMogul]またはAdobe Advertising | — | Outstream Video = Global<br>Display = NA + EMEA | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL TripleLift] |  | [!DNL TubeMogul]またはAdobe Advertising | — | グローバル | USD | ネイティブディスプレイ |
| [!DNL TripleLift Display & Outstream] |  | [!DNL TubeMogul]またはAdobe Advertising | — | グローバル | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
| [!DNL Triton] |  | Adobe Advertising | PG サポート | グローバル | USD | オーディオデスクトップとモバイル |
| [!DNL Yahoo] |  | [!DNL TubeMogul]またはAdobe Advertising | — | グローバル | USD | デスクトップとモバイルの表示<br><br> ビデオデスクトップ、モバイル、およびCTV |
