---
title: その [!UICONTROL Deal ID Inbox] の取引を受け入れる
...
# その [!UICONTROL Deal ID Inbox] の取引を受け入れる

*SSP アカウントにのみマッピングされたDSP アカウントのユーザー*

[!UICONTROL Deal ID Inbox]、[!DNL FreeWheel] （旧称 [!DNL Google Authorized Buyers]）、[!DNL AdX] （旧称 [!DNL Magnite DV+]）で既にパブリッシャーとネゴシエートしたプライベートな取引をすばやく受け入れるには、[!DNL Rubicon] を使用します。
...
1. （任意）取引の詳細を更新するには、「**[!UICONTROL Refresh]**」をクリックします。
   ...
   DSPは、毎日午前 4:30 （EST）にすべての取引の詳細を自動更新します。 また、すべての [!DNL FreeWheel] の取引を更新し、[!DNL Google] 時および [!DNL Magnite DV+] 時から既存の取引を更新します。
...
>[!MORELIKETHIS]
>
>* [[!UICONTROL Deal ID Inbox]](deal-id-inbox-about.md) について
