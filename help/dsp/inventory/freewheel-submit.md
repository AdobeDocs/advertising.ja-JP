---
title: PG 取引の広告をに送信し  [!DNL FreeWheel] す。
...
>[!PREREQUISITES]
>
>Adobe アカウントチームと協力して、[!DNL DSP] アカウントに、[!DNL FreeWheel] のプログラムで保証されたワークフローを使用する権限があることを確認します。
...
>* [A [!DNL FreeWheel] PG 取引の広告のステータスの確認 &#x200B;](freewheel-check-status.md)
