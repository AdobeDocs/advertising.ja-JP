...
Adobe Advertisingは、あらゆるメディア、データ、オーディエンス、クリエイティブを大規模に統合および自動化する、独立性を保った唯一の広告基盤です。 検索連動型、ディスプレイ、動画、コネクテッド TV （CTV）、オーディオ、ネイティブなど、広告チャネル全体で連続性のある体験を提供します。
...
>[!MORELIKETHIS]
>
>* [ ビデオ：Advertising DSPの概要](https://experienceleague.adobe.com/en/docs/advertising-learn/tutorials/dsp/intro)
>* [ ビデオ：DSP アカウント構造とユーザーインターフェイス ](https://experienceleague.adobe.com/en/docs/advertising-learn/tutorials/dsp/ui)
