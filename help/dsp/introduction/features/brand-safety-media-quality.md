...
DSPは[!DNL DoubleVerify]と提携し、[!DNL Authentic Brand Suitability]のターゲティングソリューションを提供しました。これにより、ブランドの安全性に関する一元的な要件を作成し、あらゆる購買プラットフォームをまたいでターゲットを絞り込んで一貫性を確保できます。
